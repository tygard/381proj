from internal.snthpy import build, parse_timings, generate_project as gp
import os
import shutil
import subprocess
import datetime
...
def main():
    ...
    if not os.path.isdir('C:/intelFPGA/18.1/quartus/bin64'):
        print(r'Quartus is not installed in the expected location: C:\intelFPGA\18.1\quartus\bin64\quartus_fit')

...
import datetime
import hashlib
from internal.testpy import dump_compare, mars, modelsim
...
def warn_tb_checksum():
    ...
    if observed not in expected:
        print('** Warning: It looks like src/tb.vhd has been modified. It will be graded using the version from the release **')
